...
class Tasks(models.Model):
    ...
    start_date = models.DateTimeField(auto_now_add=True) #TODO: start_date can not be started from past
    due_date = models.DateTimeField(blank=True, null=True) #TODO: due date in past should be checked
...
class TaskComment(models.Model):
    ...
    description = models.TextField()
    commented_by = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name="comment_creator")
...
class List(models.Model):
    ...
    folder = models.ForeignKey(Folder, on_delete=models.PROTECT, related_name='lists')
